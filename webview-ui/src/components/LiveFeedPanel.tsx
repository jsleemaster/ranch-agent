...
export default function LiveFeedPanel({ events, filter, assets, onSelectAgent }: LiveFeedPanelProps): JSX.Element {
  ...
  return (
    <div className="panel-body live-feed">
      ...
      {ordered.length === 0 ? <div className="empty-hint" title="작업 일지는 첫 이벤트가 오면 채워집니다">...</div> : null}
    </div>
  );
}
